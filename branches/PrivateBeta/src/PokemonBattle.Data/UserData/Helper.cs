...
namespace LightStudio.PokemonBattle.Data
{
    public static class Helper
    {
            ...
            else
            {
                ...
                foreach (var m in pm.Moves)
                {
                    ...
                    if (m.Move.Id == 237)
                    {
                        ...
                        sb.AppendFormat("[{0}]", HIDE_TYPE.Substring(pm.Iv.GetHiddenType(), 1));
                    }
                }
            }
        }
        ...
        /// <param name="pm"></param>
        /// <returns></returns>
        public static BattleType GetHiddenType(this IPokemonData pm)
        {
            return (BattleType)(pm.Iv.GetHiddenType() + 2);
        }

        public static int GetHiddenType(this I6D iv)
        {
            int pI = iv.Hp & 1;
            pI |= (iv.Atk & 1) << 1;
            pI |= (iv.Def & 1) << 2;
