...
namespace LightStudio.PokemonBattle.Game
{
  ...
  {
    static HashSet<Type> knownGameEvents = new HashSet<Type>() { typeof(AbilityEvent), typeof(BeginTurn), typeof(EndTurn), typeof(GameStartSendOut), typeof(GetItem), typeof(HealBell), typeof(HLLD), typeof(HorizontalLine), typeof(HpChange), typeof(MentalHerb), typeof(Mimic), typeof(MoveHurt), typeof(OutwardChange), typeof(PainSplit), typeof(PPChange), typeof(PositionChange), typeof(ReHurtBerry), typeof(RemoveItem), typeof(RestGame), typeof(SelectMoveFail), typeof(SendOut), typeof(SimpleEvent), typeof(StateChange), typeof(Substitute), typeof(TimeTick), typeof(UseMove), typeof(WeatherChange), typeof(Withdraw) };
