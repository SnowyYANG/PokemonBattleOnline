...
namespace LightStudio.PokemonBattle.Game.Host
{
  public interface IItemE
  {
    ...
    int CtLvRevise(PokemonProxy pm);
    ...
    /// 红线、柿果、精神香草、5树果
    /// </summary>
    void StateAdded(PokemonProxy pm, PokemonProxy by, AttachedState state);
  ...
  public static partial class EffectsService
  {
    private sealed class ItemE0 : IItemE
    {
      ...
      public int CtLvRevise(PokemonProxy pm) { return 0; }

      public void Raise(PokemonProxy pm, string key) { }

      public void Attach(PokemonProxy pm) { }
      public void HpChanged(PokemonProxy pm) { }
      public void StateAdded(PokemonProxy pm, PokemonProxy by, AttachedState state) { }
