...
namespace PokemonBattleOnline.Game.Host
{
  internal static partial class PTs
  {
    ...
    public static void HpRecover(this PokemonProxy pm, int changeHp, bool showFail = false, string log = LogKeys.HpRecover, int arg1 = 0, bool consumeItem = false)
    {
    ...
    public static void HpRecoverByOneNth(this PokemonProxy pm, int n, bool showFail = false, string log = LogKeys.HpRecover, int arg1 = 0, bool consumeItem = false)
    {
      int hp = pm.Pokemon.MaxHp / n;
      HpRecover(pm, hp, showFail, log, arg1, consumeItem);
    }
    public static bool EffectHurt(this PokemonProxy pm, int hp, string log = LogKeys.Hurt, int arg1 = 0, int arg2 = 0)
    {
      if (pm.CanEffectHurt)
      {
    ...
    public static void EffectHurtImplement(this PokemonProxy pm, int hp, string log = LogKeys.Hurt, int arg1 = 0, int arg2 = 0)
    {
      if (hp == 0) hp = 1;
    ...
    public static bool EffectHurtByOneNth(this PokemonProxy pm, int n, string log = LogKeys.Hurt, int arg1 = 0, int arg2 = 0)
    {
      return EffectHurt(pm, pm.Pokemon.MaxHp / n, log, arg1, arg2);
    }
    public static void EffectHurtByOneNthImplement(this PokemonProxy pm, int n, string log = LogKeys.Hurt, int arg1 = 0, int arg2 = 0)
    {
