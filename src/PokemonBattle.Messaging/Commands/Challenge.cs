...
using GameInitSettings = PokemonBattleOnline.Messaging.Room.GameInitSettings;
...
{
  internal class Challenge : P2PCommand<E, UE>
  {
    public override void Execute(Client<E, UE> client, User from)
    {
      throw new NotImplementedException();
    }
  }
  internal class CancelChallenge : P2PCommand<E, UE>
  {
    public override void Execute(Client<E, UE> client, User from)
    {
      throw new NotImplementedException();
  ...
  internal class RefuseChallenge : P2PCommand<E, UE>
  {
    public override void Execute(Client<E, UE> client, User from)
    {
      throw new NotImplementedException();
  ...
  internal class AcceptChallenge : P2PCommand<E, UE>
  {
    public override void Execute(Client<E, UE> client, User from)
    {
      throw new NotImplementedException();
